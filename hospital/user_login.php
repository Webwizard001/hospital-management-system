  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(isset($_POST['submit'])) {
      ...
      if($email != "" && $password != "") {
        ...
        $check = $conn->query("SELECT * FROM patient WHERE email='".$email."' AND password='".$password."' LIMIT 1");
        
        if($check->num_rows) {
          
          $data = $check->fetch_assoc();
          
          $_SESSION['admins'] = $data['email'];
...
?>
  ...
  <div class="column">
    ...
    <div class="card">
    	<img src="img/user.png" class="w3-round"  height="90" style=" padding-left:10px; margin-top:-70px;"><img src="img/correct.png" height="30" style="margin-left:-18px;" ></p>
      ...
      <input id="msg" type="email" class="form-control" name="email" placeholder="Enter email">
    </div>
        	</div>
