...
<h4 align="center" style="color: blue;">VIEW APPOINTMENT</h4>
<br>
...
$sql = mysqli_query($mysqli, "SELECT * FROM appointment  st INNER JOIN patient pt ON st.patient_id = pt.patient_id ");
