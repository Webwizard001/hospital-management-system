  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(isset($_POST['submit'])) {
      ...
      if($admin_id != "" && $password != "") {
        ...
        $check = $conn->query("SELECT * FROM admin WHERE admin_id='".$admin_id."' AND password='".$password."' LIMIT 1");
        
        if($check->num_rows) {
          
          $data = $check->fetch_assoc();
          
          $_SESSION['admins'] = $data['admin_id'];
...
?>
  ...
  <div class="column">
    ...
    <div class="card">
    	<img src="img/man (1).png" class="w3-round"  height="90" style=" padding-left:10px; margin-top:-70px;"><img src="img/correct.png" height="30" style="margin-left:-18px;" ></p>
      ...
      <input id="msg" type="text" class="form-control" name="admin_id" placeholder="Enter admin_id">
    </div>
        	</div>
